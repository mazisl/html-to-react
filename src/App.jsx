...
import Characters from './components/characters-table/characters-table.component';

import CardsContainer from './components/cards/cards-container/cards-container.component';

import './App.css'

const headerNavBtns = ['about us', 'info', 'support us'];
...
function App() {
  ...
  return (
    <>
      <Header headerNav={headerNavBtns} />
      <Characters characters={charDataArr} />
      <CardsContainer cardInfos={charDataArr} />
    </>
  )
}
